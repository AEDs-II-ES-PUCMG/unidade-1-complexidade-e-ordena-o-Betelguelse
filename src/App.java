...
public class App {
    ...
    */
    ...
    static void localizarPedidosPremium() {
        ...
        int indiceInicial = quantPedidos;
        ...
        if (indiceInicial < quantPedidos) {
            System.out.println("\nPedidos com valor final >= R$ " + String.format("%.2f", valorCorte) + ":\n");
            for (int i = indiceInicial; i < quantPedidos; i++) {
                System.out.println(pedidosOrdenadosPorValor[i].toString() + "\n");
            }
        } else {
            System.out.println("\nNenhum pedido encontrado com valor final >= R$ " + String.format("%.2f", valorCorte));
        }
    }
